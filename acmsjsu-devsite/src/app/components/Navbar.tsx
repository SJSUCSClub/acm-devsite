...
const Navbar = () => {
  ...
  return (
    <div className="navbar z-10 sticky w-screen">
      <div className="flex bg-white px-[5%] py-4 border-b-4 w-full">
        <a href="/" className='mr-auto'>
          <Image src={Logo} alt="Logo" quality={100} className="sm:h-auto max-w-[100px] h-auto" />
        </a>
        ...
        <div className="md:hidden place-content-center" >
          ...
          <button onClick={handleClick}
                ...
                <span className={`bg-black block transition-all duration-300 ease-out 
                                h-1 w-9 rounded-sm my-1 ${isOpen ? 
      ...
      <div className={`w-screen ${isOpen ? 'absolute transition ease-in flex-row bg-white justify-center text-center items-center md:hidden': 'hidden'}`}>
          <LinkCard path="/about" pathName="
                                            Us" />
          <LinkCard path="/events" pathName="Events" />
